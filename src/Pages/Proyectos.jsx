...
export function Proyectos() {
  const items = [
    ...
    },
    {
      ...
      name: "Laravel",
      color: "#ff2d1e",
      component: <ContentLenguagesCards  type="laravel"/>,
    },
    {
      icon: TbBrandCSharp,
      name: "C#",
      color: "#6C287E",
      component: <ContentLenguagesCards  type="c#"/>,
    },
    {
      icon: FaJsSquare,
      name: "Js",
      color: "#E8D44D",
      component: <ContentLenguagesCards  type="js"/>,
    },
    {
      icon: FaPhp,
      name: "PHP",
      color: "#0E82A7",
      component: <ContentLenguagesCards type="php" />,
    },
